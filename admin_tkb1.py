...
def main():
    ...
    def xoads(event):
        try:
            mylistlop.remove(lbox.get(ANCHOR))
            lbox.delete(ANCHOR)
...
#-------------------------------------------------------------------------------
    ...
    lb_loadding=Label(bg,text=" Đang tải . . . ", font=("Baloo Tamma 2 Medium",12),bg="#FCE2E9",fg="#AD7B98", width=14)
