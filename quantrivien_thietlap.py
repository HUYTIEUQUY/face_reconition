...
#-------------------------------------------------------------------------------
    ...
    cb_giobd=Combobox(bg,textvariable=giobd,values=gio,font=("Baloo Tamma",12),width=2)
    cb_giobd.place(x=577,y=165)
    cb_phutbd=Combobox(bg,textvariable=phutbd,values=phut_giay,font=("Baloo Tamma",12),width=2)
    cb_phutbd.place(x=638,y=165)
    cb_giaybd=Combobox(bg,textvariable=giaybd,values=phut_giay,font=("Baloo Tamma",12),width=2)
    cb_giaybd.place(x=698,y=165)


    cb_giokt=Combobox(bg,textvariable=giokt,values=gio,font=("Baloo Tamma",12),width=2)
    cb_giokt.place(x=577,y=217)
    cb_phutkt=Combobox(bg,textvariable=phutkt,values=phut_giay,font=("Baloo Tamma",12),width=2)
    cb_phutkt.place(x=638,y=217)
    cb_giaykt=Combobox(bg,textvariable=giaykt,values=phut_giay,font=("Baloo Tamma",12),width=2)
    cb_giaykt.place(x=698,y=217)


    cb_giotre=Combobox(bg,textvariable=giotre,values=gio,font=("Baloo Tamma",12),width=2)
    cb_giotre.place(x=577,y=347)
    cb_phuttre=Combobox(bg,textvariable=phuttre,values=phut_giay,font=("Baloo Tamma",12),width=2)
    cb_phuttre.place(x=638,y=347)
    cb_giaytre=Combobox(bg,textvariable=giaytre,values=phut_giay,font=("Baloo Tamma",12),width=2)
